...
{
    id: 11,
    url: 'http://www.teasewearproducts.com/images/nohome/underconstweb.jpg',
...

{
    ...
    price:95.00,
    material:'Outer shell is a waterproof breathable material available in a print or a solid. Inner Lining is the cooling portion made of a woven material that holds 10 times it weight in water but unlike chamios remain solf and pliant when dry',
    style:'Harper: Neck enclosure slips over the head, allowing back and chest/underbelly to fit naturally. (Velcro or webbing and buckle on both back and underbelly sides; hold coat snuggly in place. Allowing for increased girth/belly to expand i.e. pregnancy'
},
{
    id: 18,
    dir:  '/garment/regular/pricing',
...
},
{
    ...
    price:95.00,
    material:'Outer shell is a waterproof breathable material available in a print or a solid. Inner Lining is the cooling portion made of a woven material that holds 10 times it weight in water but unlike chamios remain solf and pliant when dry',
    style:'Ink Style: Saddle shape. Ideal for "Frenchies and "Pugs". webbing and buckle recommended however velcro is optional.'
},
{
    id: 20,
    dir:  '/garment/regular/pricing',
...
},
{
    ...
    price:95.00,
    material:'Outer shell is a waterproof breathable material available in a print or a solid. Inner Lining is the cooling portion made of a woven material that holds 10 times it weight in water but unlike chamios remain solf and pliant when dry',
    style:' :  Neck enclosure slips over the head, allVelco closure and the neck with a wrap portion under the belly to hold the coat snug',
...
},
{
    ...
    desc:
        "Who needs ice-cream when there's a cooling coat! The inner layer of the coat absorbs and holds water to keep the body cool and comfortable while the outer layer prevents water from wetting floors and furniture. Keeps pet cool and comfortable in summer heat. The inner layer keeps the coat dry. The outer layer can be flamboyant or subtle.",
    price:95.00,
    material:'Outer shell is a holographic print; Inner Lining is the cooling portion made of a woven material that holds 10 times it weight in water but unlike chamios remain solf and pliant when dry',
    style:'Misha:  Neck enclosure slips over the head, allowing back and chest/underbelly to fit naturally. (Velcro strap) or alternatively (webbing and buckle) rise from rear of underbelly to wrap around back to hold coat snuggly in place. Dog\'s rear legs are inserted through elastic straps to ensure garment remains in place'
},
{
    id: 23,
    dir:  '/garment/regular/pricing',
...
},
{
    ...
    price:95.00,
    material:'Outer shell is a holographic print; Inner Lining is the cooling portion made of a woven material that holds 10 times it weight in water but unlike chamios remain solf and pliant when dry',
    style:'Tease:  Velco closure and the neck with a wrap portion under the belly to hold the coat snug'
},
...

{
    ...
    caption: 'Body Socks',
    desc:
    "The body sock is a tight fighting garment made specifically for each dog.  It is designed with the dog’s owner to ensure that it is perfect for the individual dog and breed requirements.  Once a dog has been totally or partially dried and the coat is lying how the handler wishes, the sock is put on and rolled down the dog to ensure that the coat remains in the right place.  Some coats have a tendency to wisp or curl in the final stages of drying, the body sock ensures that this is minimised and gives the handler confidence that the coat will stay where they left it With the option of a high neck,  the transition from head, through withers and along the top line can be blended beautifully without an obvious kink which some drying options can create. Velcro tabs close the sock just under the tail gland so ensuring that the transition from top line to tail is consistent and unmarked. The sock is designed for the legs to be exposed thus not interfering with any feathering, however, it is tight enough around the return of shoulder to keep the coat smooth down from the withers and accentuate structure and muscle tone.",
    price:20.00
},
{
    id: 57,
...
},
{
    ...
    caption: 'Rain Coats',
    desc:
    'Pyscadelic No more wet dog smell!  Waterproof outer layer and a light soft inner layer to keep pets dry. Splash pants are also highly recommended with this item.',
    price:150.00
},
{
    id: 62,
